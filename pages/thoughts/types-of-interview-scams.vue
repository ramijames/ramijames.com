<template>
  ...
  <main class="w-content page-top">
    <section class="content">
      <NuxtImg sizes="sm:100vw md:80vw lg:1000px" loading="lazy" src="/articles/types-of-interview-scams.png" alt="Types of interview scams" />
      ...
      <p><NuxtImg sizes="sm:100vw md:80vw lg:1000px" loading="lazy" src="/articles/interview-scam-emma.png" alt="Example of a scam interview message" /></p>
      ...
      <p>I spent a frantic few days trying to get any flight (or boat) out to any destination in Europe so that I could meet them. </p>
      ...
      <p>We met up in Athens and then moved to Cyprus, hoping that things would wind down quickly. They didn’t, but that’s outside the scope of what I’m trying to convey here. While we were in Cyprus, maybe two or three weeks after I met up with my wife and kids, I got approached on Twitter to take on a consulting role for a game that was being produced. I checked out their social accounts, which had substantial followings and good engagement, and their project’s website. I even poked around their Discord and talked to some people who were excited about the game. Everything seemed above board so I said that I’d be ok to take a call with their team to discuss things.</p>
      <p>When we showed up to the call, there was a nicely dressed woman with an eastern European accent. We spoke for 30-40 minutes and I asked about what they were trying to build, why, and how things were going. She asked smart questions about my background and seemed interested in getting my opinions on an early build of the game called Myst Island. </p>
      <p>We agreed on a reasonable hourly rate, with an understanding that a retainer would be appropriate for both sides if they found my feedback and network valuable. <strong>I was desperate for any income at this time and agreed.</strong></p>
      <p>At the end of the call she casually mentioned that they’d send over a link to a build that I could install and play with. </p>
      ...
      <p><NuxtImg sizes="sm:100vw md:80vw lg:1000px" loading="lazy" src="/articles/interview-scam-windows.png" alt="Scam interview on Windows" /></p>
      <p>I ran it anyway.</p>
      <p>The install process took a few minutes, and then got stuck.</p>
      <p><NuxtImg sizes="sm:100vw md:80vw lg:1000px" loading="lazy" src="/articles/interview-scam-mystisland.png" alt="Mystisland scam interview" /></p>
      ...
      <p>The computer got closed and I went to go play with my kids. A little later, I happened to check Telegram and I saw that there was a weird “saved message” saying that I’d been hacked and they took all my ETH. That’s when everything clicked for me and I hit maximum panic. </p>
      <p>I ran over to my machine and checked. Indeed, I’d been wiped out.</p>
      ...
      <li><p>Don’t keep keys or seed phrases any place that people can easily access.</p>
      </li>
      <li><p>Don’t install stuff that you haven’t verified or had some third party verify.</p>
      </li>
