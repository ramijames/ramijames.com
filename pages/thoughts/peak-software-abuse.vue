<template>
  <main class="general-main page-top">
    <section class="article-extras">
      <SectionTitle title="Peak software abuse" subtitle="by Rami James" />
      <AllPosts />
    </section>
    <section class="content">
      ...
      <p>Today, I can’t in good conscience recommend that developers use NFTs within their games or other software products. Don’t do it. It’s bad for your users and your ecosystem, and in the long run, it will be bad for your business. Lastly, it’s bad for the developers that need to implement it.</p>
      <p>If you, for whatever reason, disagree, I suggest that you don’t create a limited supply and you don’t charge for them. Give them away to your community for free. That’s what they are worth.</p>
      <p>I’ve tried to get this viewpoint across to everyone that I’ve worked with, to no avail. Mostly, at this point, I’ve just given up. I see very few projects that seem to understand why there was so much pushback from gamers, developers, and publishers. They are stuck in a for-profit mindset that limits their vision and potential. The way that they are integrating NFTs into their stack is a reflection of that.</p>
      <p>How NFTs are currently being implemented in games and other software is just the modern-day version of the same abusive bullshit that I’ve seen throughout my career. </p>
      <p>I have tried almost every version of NFTs over the past six years. I bought fake land. I bought fake art. I bought profile pics. I bought in-game assets. I talked to everybody and I tried hard to understand every viewpoint. I wanted to see for myself how things worked, how developers were using the tech, and how it affected end users.</p>
      <p>The only meaningful interactions that I had over the years were with struggling artists who used NFTs to fund their creative pursuits. Mostly, those artists weren’t even really offering anything in exchange. They minted their fake art. I paid for it. They used that money to make more cool stuff. It was straightforward and it was honest. I knew exactly what I was getting into.</p>
      <p>Within the context of gaming, NFTs enable fake scarcity, market manipulation, and rug pulls that underscore that these digital assets are not for the benefit of the end-users who just want to play a fun game. They are just another way to squeeze money from users for the benefit of the people who are running the show. No wonder people hate them. No wonder smart developers are stepping back from plans to use them in their games.</p>
      <p>That’s not what I wanted for the software that I was trying to get built, but here we are. No one person is ever in control of the fate of a market. We’re all just along for the ride. I regret being part of it.</p>
      <p>I think that the main problem with blockchain technologies is not the tech at all. For the most part, many of the core technology challenges have been solved and we are at a scaling phase. The main problem today is a people problem. If you build networks on which anyone can do anything, bad people will do bad things. No amount of altruistic intent will change that. You have to choose to do the right thing and most people don’t.</p>
      <p>What is wrong with blockchain networks is simply that this truth is not accepted. It isn&#39;t taken as a fact that things are bad and solutions aren&#39;t discussed at a product level. Developers are focused on producing technical solutions and are not addressing the very real human problems. Until they are, mainstream audiences should maintain a healthy distance.</p>
      <p>We can deal with the wider software abuse patterns in the market by voting with our wallets. It all boils down to that. We have a choice in what software we use, and what we pay for. I choose to use open-source software when I can, and use the products of companies I want to support when I can’t. You should, too.</p>
      <p>Oh, and let NFTs die. It’s time.</p>
