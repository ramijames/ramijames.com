<template>
  ...
  <main class="w-content page-top">
    <section class="content">
      ...
      <NuxtImg sizes="sm:100vw md:80vw lg:1000px" loading="lazy" src="/articles/iterate-relentlessly.png" alt="Iterate relentlessly" tagline="It is immensely hard to get traction for your product, and that is often because you have built the wrong thing and nobody wants to use that. Here is a better process." />
      ...
      <p>Too little and your product doesn’t make much of a splash.</p>
      <p>Too much and you spend too long building and either run out of money or the market moves on and you’ve missed your opportunity.</p>
      ...
      <p>Interviewing is the commonly accepted methodology within Product Management (and UX) processes in most large companies. </p>
      <h3 id="formal-interview-process">Formal Interview process</h3>
      <p>Product Managers (or Owners, or UX specialists) produce a set of questions to ask users of a product. These specialists target areas for improvement and try to illuminate user pain points. Intermittent interviews are set and run periodically, as time allows.</p>
      <p>The feedback from the interviews is then digested by those specialists and fed back into the product cycle. </p>
      <p>My core gripes with this methodology are that </p>
      <ul>
      <li><p>There are many assumptions built into it that narrow user feedback down</p>
      </li>
      <li><p>Interviews happen only intermittently and feedback is not always immediate accessible by those who need it most</p>
      </li>
      </ul>
      <p>In trying to create a consistent process, you will often miss important edge cases, user groups you didn’t think of (and engage with), and product problems due to predetermined expectations.</p>
      ...
      <p>The information that you, your designers, and your engineers gather directly from those interactions is fed directly back into your product cycle so that you can determine each insight’s level of importance and impact.</p>
