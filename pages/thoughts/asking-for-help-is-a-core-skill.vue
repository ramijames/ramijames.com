<template>
  <main class="general-main page-top">
    ...
    <section class="content">
      ...
      <h2 id="every-blocker-is-a-learning-opportunity">Every blocker is a learning opportunity</h2>
      ...
      <h2 id="your-ego-will-limit-you-if-you-let-it">Your ego will limit you if you let it</h2>
