<template>
  ...
  <main class="w-content page-top">
    <section class="content">
      ...
      <p>Additionally, I wrote <a href="https://www.ramijames.com/thoughts/how-to-iterate-relentlessly">about how you can’t necessarily trust what users tell you</a> when iterating through a product life cycle. What users tell you is often only a slice of the full picture and can not be taken at face value.</p>
