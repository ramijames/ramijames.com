  ...
  <main class="product-main">
    ...
    <section class="product-content">
      ...
      <aside class="story-time">
        ...
        <ul>
          <li>Scatter Desktop - Our desktop, Electron-based signing wallet.</li>
          <li>Scatter Mobile - Our mobile native signing wallet, unreleased.</li>
          <li>Scatter JS - The developer-facing signing library used for integration with our wallet.</li>
          <li>Scatter Marketplace - The prototype digital products marketplace released in 2019.</li>
          <li>Scatter Identity (RIDL) - The digital identity network and extension for providing anonymous, verifiable identities on web3.</li>
        </ul>

        <p>We were constantly evolving the product, and it dramatically improved over the two years that we worked on it.</p>

        <p>It was a lot to manage, and we were always looking for ways to simplify our product offering while still providing value to our users.</p>
